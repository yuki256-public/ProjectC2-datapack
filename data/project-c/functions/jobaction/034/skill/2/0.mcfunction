...
execute if entity @s[team=Red] run summon wolf ~ ~1 ~ {CustomName:"\"わんこマター\"",Tags:["Battle","034-wolfR","034-wolfF","034-wolf"],Attributes:[{Name:generic.maxHealth,Base:20},{Name:generic.movementSpeed,Base:0.3},{Name:generic.attackDamage,Base:3},{Name:generic.followRange,Base:100}],Health:20.0f}
execute if entity @s[team=Blue] run summon wolf ~ ~1 ~ {CustomName:"\"わんこマター\"",Tags:["Battle","034-wolfB","034-wolfF","034-wolf"],Attributes:[{Name:generic.maxHealth,Base:20},{Name:generic.movementSpeed,Base:0.3},{Name:generic.attackDamage,Base:3},{Name:generic.followRange,Base:100}],Health:20.0f}
