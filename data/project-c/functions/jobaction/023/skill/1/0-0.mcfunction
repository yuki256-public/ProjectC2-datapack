...
summon armor_stand ~ ~ ~ {Tags:["023-1-Animation","023-10"],Marker:1b,NoGravity:1b,Invisible:1b}
execute as @e[tag=023-1-Animation] at @s run function project-c:jobaction/023/skill/1/0-0a
