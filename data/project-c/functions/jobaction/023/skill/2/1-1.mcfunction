...
tp @s ~ ~ ~ ~6 ~
execute if entity @s[team=RedDummy] positioned ~ ~0.1 ~ run particle minecraft:dust 0.33 1 1 2 ^3.0 ^ ^ 0 0 0 1 1 normal @a[team=Red]
execute if entity @s[team=RedDummy] positioned ~ ~0.1 ~ run particle minecraft:dust 0.33 1 1 2 ^-3.0 ^ ^ 0 0 0 1 1 normal @a[team=Red]
execute if entity @s[team=RedDummy] positioned ~ ~0.1 ~ run particle minecraft:dust 0.33 1 1 2 ^ ^ ^3.0 0 0 0 1 1 normal @a[team=Red]
execute if entity @s[team=RedDummy] positioned ~ ~0.1 ~ run particle minecraft:dust 0.33 1 1 2 ^ ^ ^-3.0 0 0 0 1 1 normal @a[team=Red]
...
execute if entity @s[team=RedDummy] positioned ~ ~0.35 ~ run particle minecraft:dust 0.33 1 1 2 ^ ^ ^3.0 0 0 0 1 1 force @a[team=Red]
execute if entity @s[team=RedDummy] positioned ~ ~0.35 ~ run particle minecraft:dust 0.33 1 1 2 ^ ^ ^-3.0 0 0 0 1 1 force @a[team=Red]
execute if entity @s[team=BlueDummy] positioned ~ ~0.1 ~ run particle minecraft:dust 0.33 1 1 2 ^3.0 ^ ^ 0 0 0 1 1 normal @a[team=Blue]
execute if entity @s[team=BlueDummy] positioned ~ ~0.1 ~ run particle minecraft:dust 0.33 1 1 2 ^-3.0 ^ ^ 0 0 0 1 1 normal @a[team=Blue]
execute if entity @s[team=BlueDummy] positioned ~ ~0.1 ~ run particle minecraft:dust 0.33 1 1 2 ^ ^ ^3.0 0 0 0 1 1 normal @a[team=Blue]
execute if entity @s[team=BlueDummy] positioned ~ ~0.1 ~ run particle minecraft:dust 0.33 1 1 2 ^ ^ ^-3.0 0 0 0 1 1 normal @a[team=Blue]
