execute as @e[tag=023-22s] if score @s playerNumber = @e[limit=1,sort=nearest,distance=..0.01,tag=023-22] playerNumber run kill @s
particle minecraft:dust 1 0.33 1 3 ~ ~ ~ 5 5 5 1 600 normal @a
particle minecraft:dust 1 0.33 1 3 ~ ~ ~ 5 5 5 1 150 force @a
playsound minecraft:entity.generic.explode master @a ~ ~ ~ 2 1
playsound minecraft:entity.wither.death master @a ~ ~ ~ 2 0.5
playsound minecraft:entity.wither.death master @a ~ ~ ~ 2 0.5

summon armor_stand ~3.5 ~ ~ {Tags:["023-n-Animation","023-7-22s"],Marker:1b,NoGravity:1b,Invisible:1b,Rotation:[0.0f,0.0f]}
summon armor_stand ~-3.5 ~ ~ {Tags:["023-n-Animation","023-7-22s"],Marker:1b,NoGravity:1b,Invisible:1b,Rotation:[180.0f,0.0f]}
