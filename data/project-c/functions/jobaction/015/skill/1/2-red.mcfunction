...
execute at @s run teleport @s ^ ^ ^0.15 facing entity @a[team=Blue,sort=nearest,limit=1]


execute if entity @a[team=Blue,distance=..1.5] run function project-c:jobaction/015/skill/1/2-success
