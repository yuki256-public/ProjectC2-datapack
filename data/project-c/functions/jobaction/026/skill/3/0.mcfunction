...
give @s minecraft:iron_axe{display:{Name:"{\"text\":\"銀の斧\",\"color\":\"gray\",\"underlined\":true,\"italic\":false}",Lore:["§7泉から出てきた貴重な斧。","§f少し叩いても壊れない。","","§7利き手に持ったとき:"," §3攻撃速度 1.0"," §3攻撃力 9"]},Enchantments:[{id:fortune,lvl:1s}],AttributeModifiers:[{Name:"HaruEditor",UUIDLeast:353042502l,UUIDMost:353042502l,Operation:0,AttributeName:"generic.attackSpeed",Amount:-3d,Slot:"mainhand"},{Name:"HaruEditor",UUIDLeast:353042502l,UUIDMost:353042502l,Operation:0,AttributeName:"generic.attackDamage",Amount:8d,Slot:"mainhand"}],HideFlags:2,Damage:248} 1
