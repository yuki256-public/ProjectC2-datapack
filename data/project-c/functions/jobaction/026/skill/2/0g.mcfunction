...
execute if entity @s[team=Red] at @s run summon armor_stand ^ ^ ^1 {Tags:["026-axe","026-Gaxe","026-axeSummoned","026-GaxeR"],Invisible:1b,Marker:1b,Glowing:1b,HandItems:[{id:"minecraft:golden_axe",Count:1b,tag:{Enchantments:[{id:16,lvl:1}]}},{id:"minecraft:golden_axe",Count:1b,tag:{Enchantments:[{id:16,lvl:1}]}}],Pose:{RightArm:[-90f,0f,0f],LeftArm:[-90f,0f,0f]},DisabledSlots:2039583}
execute if entity @s[team=Blue] at @s run summon armor_stand ^ ^ ^1 {Tags:["026-axe","026-Gaxe","026-axeSummoned","026-GaxeB"],Invisible:1b,Marker:1b,Glowing:1b,HandItems:[{id:"minecraft:golden_axe",Count:1b,tag:{Enchantments:[{id:16,lvl:1}]}},{id:"minecraft:golden_axe",Count:1b,tag:{Enchantments:[{id:16,lvl:1}]}}],Pose:{RightArm:[-90f,0f,0f],LeftArm:[-90f,0f,0f]},DisabledSlots:2039583}
